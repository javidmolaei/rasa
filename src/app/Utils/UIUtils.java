...
public class UIUtils {
    ...
    public static final Color COLOR_INTERACTIVE_STOP = new Color(158, 50, 50);
    ...
    public static final String BUTTON_TEXT_TITLE = "RASA TEAM PROJECT";
    public static final String PLACEHOLDER_TEXT_OBJECT = "OBJECT";
    public static final String PLACEHOLDER_TEXT_BOX = "BOX";
    public static final String PLACEHOLDER_TEXT_BOX_WEIGHT = "WEIGHT";
    public static final String PLACEHOLDER_TEXT_INPUT = "INPUT (example:5 2 1 4 2)";
    public static final String BUTTON = "RUN";
